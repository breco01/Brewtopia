            ...
            <div class="max-w-7xl mx-auto px-6 py-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p class="text-gray-600 mb-4">Bekijk en bewerk recensies die je hebt geschreven voor verschillende bieren.</p>
                        <a href="{{ route('reviews.index') }}" class="text-yellow-600 hover:text-yellow-700 font-medium">Beheer Recensies &rarr;</a>
                    </div>

                    <!-- Voeg een Bier toe -->
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        <h2 class="text-xl font-bold text-gray-800 mb-4">Voeg een Nieuw Bier toe</h2>
                        <p class="text-gray-600 mb-4">Draag bij aan de database door een nieuw bier toe te voegen voor anderen om te recenseren.</p>
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p class="text-gray-600 mb-4">Houd bij welke bieren je hebt geproefd of die je in de toekomst wilt proberen.</p>
                        <a href="{{ route('beers.list') }}" class="text-yellow-600 hover:text-yellow-700 font-medium">Bekijk Mijn Lijst &rarr;</a>
                    </div>

                    <!-- Hoogst Beoordeelde Bieren -->
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        <h2 class="text-xl font-bold text-gray-800 mb-4">Hoogst Beoordeelde Bieren</h2>
                        <p class="text-gray-600 mb-4">Bekijk de hoogst beoordeelde bieren uit de Brewtopia gemeenschap.</p>
                        <a href="{{ route('beers.top') }}" class="text-yellow-600 hover:text-yellow-700 font-medium">Verken Hoogst Beoordeelde Bieren &rarr;</a>
                    </div>

                    <!-- Gemeenschap -->
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        <h2 class="text-xl font-bold text-gray-800 mb-4">Gemeenschap</h2>
                        <p class="text-gray-600 mb-4">Verbonden raken met andere bierliefhebbers en je ervaringen delen.</p>
                        <a href="{{ route('community.index') }}" class="text-yellow-600 hover:text-yellow-700 font-medium">Word Lid van de Gemeente &rarr;</a>
                    </div>
