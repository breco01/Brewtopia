    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow">
            <div class="relative bg-yellow-500 py-24">
                <div class="max-w-7xl mx-auto px-6 text-center text-white">
                    ...
                    <p class="text-xl mb-8">Discover, review, and share your love for craft beers with the Brewtopia community.</p>
                    <a href="#" class="bg-yellow-600 hover:bg-yellow-700 text-white py-3 px-8 rounded-full text-lg font-semibold transition-colors shadow-lg">Get Started</a>
                </div>
            </div>
        </main>
        ...
        <section class="py-16 bg-gray-100">
            <div class="max-w-7xl mx-auto px-6 text-center">
                ...
                <p class="text-lg text-gray-600 mb-10">Brewtopia is your personal platform for discovering new beers, sharing your thoughts, and exploring recommendations from the community.</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">Discover Beers</h3>
                        <p class="text-gray-600">Explore a curated selection of the best craft beers from around the world.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">Rate & Review</h3>
                        <p class="text-gray-600">Share your thoughts on the beers you've tried and read reviews from others.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">Connect with Friends</h3>
                        <p class="text-gray-600">Follow your friends, share your favorite beers, and enjoy tasting experiences together.</p>
                    </div>
                </div>
            </div>
        </section>
